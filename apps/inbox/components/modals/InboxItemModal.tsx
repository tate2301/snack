				...
				<div className="w-[36rem]">
					...
					<div className="py-4 border-t">
						...
						<div className="flex mt-4">
							<button className="flex items-center justify-center gap-2 px-2 py-1 uppercase transition-all bg-white border rounded-lg shadow-sm border-zinc-100 text-zinc-500 hover:border-zinc-200 hover:text-zinc-900">
